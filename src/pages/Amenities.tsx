...
import { Bath, Dumbbell, WavesLadder, Leaf, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Bath key={0} />, <Dumbbell key={1} />, <WavesLadder key={2} />, <Leaf key={3} />],
